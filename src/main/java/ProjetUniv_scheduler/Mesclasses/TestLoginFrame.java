...
public class TestLoginFrame extends JFrame {
    ...
    public TestLoginFrame() {
        setTitle("UNIV-SCHEDULER — Connexion Test");
    ...
    private void tenterConnexion() {
        ...
        Utilisateur user = SimpleDAO.authentifier(id, mdp);
        ...
        if (user != null) {
            ...
            JOptionPane.showMessageDialog(this, 
                ...
                "Rôle: " + (user.getRole() != null ? user.getRole() : "Non défini"), 
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TestLoginFrame().setVisible(true));
    }
}
