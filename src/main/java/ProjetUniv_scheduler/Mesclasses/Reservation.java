...
public class Reservation {
    ...
    @ManyToOne
    @JoinColumn(name = "identifiant_reservateur")
    ...
    public Reservation(Creneau monCreneau, String natureSession, int niveauPriorite, Utilisateur reservateur) {
    ...
    public Utilisateur getReservateur() { return reservateur; }
    public void setReservateur(Utilisateur reservateur) { this.reservateur = reservateur; }
}
